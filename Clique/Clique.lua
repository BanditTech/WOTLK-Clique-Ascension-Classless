...
function Clique:SpellBookButtonPressed(frame, button)
    ...
    local texture = GetSpellTexture(id, AscensionSpellbookFrame.bookType)
    local name, rank = GetSpellName(id, AscensionSpellbookFrame.bookType)
    ...
    local t = {
		...
		["texture"] = GetSpellTexture(id, AscensionSpellbookFrame.bookType),
		["type"] = type,
		["arg1"] = name,
		["arg2"] = rank,
    }
